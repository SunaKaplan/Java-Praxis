...
public class C06_DoWhileLoop {
    ...
    */
        ...
        double toplamYol=0;//soruda istendigi icin basta konteynir olusturdum
        int vurmaSayisi=0;//soruda istendigi icin basta konteynir olusturdum

       do {
           toplamYol+=yukseklik;  //burada toplam yol=toplam yol+yukseklik i buluyorum
           vurmaSayisi++;
