...
public class C01_NestedForLoop {
    ...
    public static void ucgenCiz(int satirSayisi, char ch) {
        ...
        for (int i = 0; i <satirSayisi ; i++) { // bu dongu herbir satir icin calisacak
            ...
            for (int j = 0; j <i+1; j++) { // bu dongu herbir character icin calisacak
                System.out.print(ch+ " ");

            }
            System.out.println(); // bunu her dongu bittikten sonra imlecin alttaki satira gecmesi icin yaptik
